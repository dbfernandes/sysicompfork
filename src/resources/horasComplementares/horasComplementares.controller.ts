...
const listarHoras = async (_req: Request, res: Response) => {
  const MockHoras = [
    { id: 1, descricao: 'descrição 01', atividade: '9.1: Carga Horária Optativa Excedente', data_inicio: '02/05/2023', data_termino: '24/06/2023', horaTotal: 32, horaAprovada: 32, status: 'deferido' },
    { id: 2, descricao: 'descrição 02', atividade: '9.1: Carga Horária Optativa Excedente', data_inicio: '02/05/2023', data_termino: '24/06/2023', horaTotal: 70, horaAprovada: 60, status: 'deferido' }
  ];
